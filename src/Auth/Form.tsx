...
export default function SignIn({ page }: { page: "login" | "register" }) {
    ...
    const emailError =
        !!loginRegForm.errors.email && loginRegForm.touched.email;
    const usernameError =
        !!loginRegForm.errors.username && loginRegForm.touched.username;
    const passwordError =
        !!loginRegForm.errors.password && loginRegForm.touched.password;
                ...
                >
                    {page === "register" && (
                        <FormControl>
                            ...
                            <TextField
                                error={usernameError}
                                helperText={
                                    loginRegForm.touched.username &&
                                    loginRegForm.errors.username
                                }
                                size="small"
                                id="username"
                                type="text"
                    ...
                    <FormControl>
                        ...
                        <TextField
                            error={emailError}
                            helperText={
                                loginRegForm.touched.email &&
                                loginRegForm.errors.email
                            }
                            size="small"
                            id="email"
                            type="email"
                    ...
                    <FormControl>
                        ...
                        <TextField
                            error={passwordError}
                            helperText={
                                loginRegForm.touched.password &&
                                loginRegForm.errors.password
                            }
                            size="small"
                            name="password"
                            placeholder="••••••"
                    ...
                    <Button
                        ...
                        variant="contained"
                        disabled={
                            !loginRegForm.isValid || loginRegForm.isSubmitting
                        }
                        startIcon={
                            loginRegForm.isSubmitting ? (
